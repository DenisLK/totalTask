...
Задаем один массив размером size и заполняем его значениям,так же создаем еще один массив размером size,туда будут записываться данные после проверки первого массива.
...
## Программа для решения задачи на C#
В папке Solution решение задачи на C#.